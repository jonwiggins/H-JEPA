...
def example_masking_visualization():
    ...
    fig = visualize_masking_strategy(mask, title="Example Masking Pattern")
    plt.savefig(
        "/home/user/H-JEPA/results/visualizations/example_mask.png", dpi=150, bbox_inches="tight"
    )
    plt.close(fig)
    print("Saved: example_mask.png")

    # Multi-block masking
    fig = visualize_multi_block_masking(num_samples=6, grid_size=14, num_blocks=4)
    plt.savefig(
        "/home/user/H-JEPA/results/visualizations/example_multiblock.png",
        dpi=150,
        bbox_inches="tight",
    )
    plt.close(fig)
    ...
    plt.savefig(
        "/home/user/H-JEPA/results/visualizations/example_comparison.png",
        dpi=150,
        bbox_inches="tight",
    )
    plt.close(fig)
...
def example_feature_space_visualization():
    ...
    fig = visualize_feature_space(
        features, labels=labels, method="tsne", perplexity=30, random_state=42
    )
    plt.savefig(
        "/home/user/H-JEPA/results/visualizations/example_tsne.png", dpi=150, bbox_inches="tight"
    )
    plt.close(fig)
    print("Saved: example_tsne.png")

    print("Visualizing feature space with PCA...")
    fig = visualize_feature_space(features, labels=labels, method="pca")
    plt.savefig(
        "/home/user/H-JEPA/results/visualizations/example_pca.png", dpi=150, bbox_inches="tight"
    )
    plt.close(fig)
...
def example_embedding_analysis():
    ...
    plt.savefig(
        "/home/user/H-JEPA/results/visualizations/example_healthy_embeddings.png",
        dpi=150,
        bbox_inches="tight",
    )
    plt.close(fig)
    ...
    plt.savefig(
        "/home/user/H-JEPA/results/visualizations/example_healthy_collapse.png",
        dpi=150,
        bbox_inches="tight",
    )
    plt.close(fig)
    ...
    plt.savefig(
        "/home/user/H-JEPA/results/visualizations/example_collapsed_embeddings.png",
        dpi=150,
        bbox_inches="tight",
    )
    plt.close(fig)
    ...
    plt.savefig(
        "/home/user/H-JEPA/results/visualizations/example_collapsed_collapse.png",
        dpi=150,
        bbox_inches="tight",
    )
    plt.close(fig)
...
def example_training_visualization():
    ...
    plt.savefig(
        "/home/user/H-JEPA/results/visualizations/example_training_curves.png",
        dpi=150,
        bbox_inches="tight",
    )
    plt.close(fig)
    ...
    plt.savefig(
        "/home/user/H-JEPA/results/visualizations/example_hierarchical_losses.png",
        dpi=150,
        bbox_inches="tight",
    )
    plt.close(fig)
    ...
    plt.savefig(
        "/home/user/H-JEPA/results/visualizations/example_ema_momentum.png",
        dpi=150,
        bbox_inches="tight",
    )
    plt.close(fig)
