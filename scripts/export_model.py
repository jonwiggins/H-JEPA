...
from src.inference.optimized_model import export_to_onnx, export_to_torchscript, quantize_model
...
def main():
    ...
    parser.add_argument(
        "--hierarchy-level", type=int, default=0, help="Hierarchy level for feature extraction"
    )
    parser.add_argument(
        "--quantization-type",
        type=str,
