...
# Add some statistics
if losses:
    plt.axhline(y=losses[0], color='red', linestyle='--', alpha=0.5, label=f'Initial: {losses[0]:.4f}')
    plt.axhline(y=losses[-1], color='green', linestyle='--', alpha=0.5, label=f'Current: {losses[-1]:.4f}')
